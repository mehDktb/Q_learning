...
for episode in range(episodes):
    ...
    for step in range(max_steps):
        ...
        current_state, score, reward = apply_transition(current_state=current_state, action=action, grid_map=grid_map, states=states, rewards=rewards, score=score)
...
print(Q_table)
path = get_best_path(Q_table=Q_table, grid_map=grid_map, states=states, rewards=rewards, start=start, goal=goal)
print(path)
